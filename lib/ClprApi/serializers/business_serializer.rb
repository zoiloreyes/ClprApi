module ClprApi
  module Serializers
    class BusinessSerializer < ActiveModel::Serializer
      ...
      attributes :id,:name, :license, :phone, :phone_ext, :phone2, :phone2_ext, :phone2_ext, :address1, :address2, :city, :state, :country, :postal_code, :url, :logo_path, :logo, :slug, :industry, :location_string
